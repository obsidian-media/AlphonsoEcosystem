...
Alphonso is licensed under **BSL 1.1** (Business Source License). Personal use is free. Commercial use of connectors beyond the Free tier requires a paid license. See [LICENSE](https://github.com/Thatisshayan/AlphonsoEcosystem/blob/main/LICENSE) for details.
