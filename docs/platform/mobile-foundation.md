...
Inbox now groups every current decision record into **Needs your judgement**, **Confirmation queue**, and read-only **Recorded** sections. Review and challenge-ready records share the same evidence/policy detail route; confirmation records remain explicitly non-executing accountability evidence.
