...
- Slack / Discord / custom webhook connection URLs configured in the Tool Connections panel
- Local SD WebUI / ComfyUI runtime endpoints available on this machine

See `docs/EXTERNAL_CONNECTOR_SETUP.md` for the full step-by-step setup checklist.
