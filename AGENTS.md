...
- **Version**: 2.7.1 (security hardened, 346 test files, 5,094 tests, 191 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                346 test files, 5,094 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 5,094 tests (346 files)
