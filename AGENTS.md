...
- **Version**: 2.6.4 (security hardened, 285 test files, 4,199 tests, 187 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  services/            187 services (policy-gated, not stubs; 185/185 audited line-by-line 2026-07-28)
  ...
  test/                285 test files, 4,199 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 4,199 tests (285 files; verified 2026-08-22)
...
## Do Not Duplicate
Before writing any new service, component, or feature, check `CLAUDE.md` "Do Not Duplicate" table at project root. 187 services already exist.
