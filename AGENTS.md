...
ios/                   iOS companion app (SwiftUI)
  ...
  src/lib.rs           ~1,660 lines, 110 Tauri commands (across 31 modules)
...
cargo test                # 117 Rust `#[test]`-attributed unit tests (across 31 modules; cargo test itself reports slightly more passing due to a handful of #[tokio::test] async tests this static count doesn't match)
