...
- **Version**: 2.6.2 (security hardened, 284 test files, 4,199 tests, 187 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                284 test files, 4,199 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 4,199 tests (284 files; verified 2026-08-22)
