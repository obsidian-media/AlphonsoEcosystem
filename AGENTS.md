...
- **Version**: 2.7.1 (security hardened, 359 test files, 5,239 tests, 196 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  services/            197 services (policy-gated, not stubs; 185/185 audited line-by-line 2026-07-28)
  ...
  test/                364 test files, 5,239 tests (Vitest; see ground truth for current verification status)
ios/                   iOS companion app (SwiftUI)
  ...
  src/lib.rs           ~807 lines, 118 Tauri commands (across 38 modules)
...
npm run test             # 5,239 tests (364 files)
...
- All 26 connectors (Telegram, WhatsApp Cloud, YouTube, mobile_bridge, ChatGPT, Claude, Qwen, Notion, ClickUp, SD WebUI, ComfyUI Video, Runway, GitHub, Slack, Discord, Generic Webhook, Ollama, Brave Search, Perplexity, Tavily, DeepSeek, NVIDIA NIM, Gemini, n8n, Hermes Agents, CALL-E) are policy-gated
...
## Do Not Duplicate
Before writing any new service, component, or feature, check `CLAUDE.md` "Do Not Duplicate" table at project root. 188 services already exist.
