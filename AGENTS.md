...
ios/                   iOS companion app (SwiftUI)
  ...
  src/lib.rs           ~2,043 lines, 110 Tauri commands (across 29 modules)
...
cargo test                # 117 Rust `#[test]`-attributed unit tests (across 29 modules; cargo test itself reports slightly more passing due to a handful of #[tokio::test] async tests this static count doesn't match)
