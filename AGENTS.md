...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  services/            196 services (policy-gated, not stubs; 185/185 audited line-by-line 2026-07-28)
  ...
  test/                359 test files, 5,239 tests (Vitest; see ground truth for current verification status)
ios/                   iOS companion app (SwiftUI)
  ...
  src/lib.rs           ~806 lines, 117 Tauri commands (across 38 modules)
...
npm run test             # 5,239 tests (359 files)
