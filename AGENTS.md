...
- **Version**: 2.6.1 (security hardened, 250 test files, 3,611 tests, 169 services)
...
src/                   React frontend (100% .tsx — 116 components, 0 .jsx remaining)
  ...
  test/                250 test files, 3,611 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 3,611 tests (250 files; verified 2026-07-23)
