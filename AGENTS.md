...
- **Version**: 2.6.0 (security hardened, 230 test files, 3,255 tests, 168 services)
...
src/                   React frontend (100% .tsx — 114 components, 0 .jsx remaining)
  ...
  test/                230 test files, 3,255 tests (Vitest, all passing)
...
npm run test             # 3,255 tests (230 files; all passing)
