...
- **Version**: 2.7.1 (security hardened, 356 test files, 5,182 tests, 193 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  services/            193 services (policy-gated, not stubs; 185/185 audited line-by-line 2026-07-28)
  ...
  test/                356 test files, 5,182 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 5,182 tests (356 files)
