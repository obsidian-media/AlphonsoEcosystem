...
- **Version**: 2.7.1 (security hardened, 317 test files, 4,815 tests, 191 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                317 test files, 4,815 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 4,815 tests (317 files)
