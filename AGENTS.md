...
- **Version**: 2.7.1 (security hardened, 351 test files, 5,107 tests, 191 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                351 test files, 5,107 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 5,107 tests (351 files)
