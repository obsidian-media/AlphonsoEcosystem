...
- **Version**: 2.6.1 (security hardened, 253 test files, 3,516 tests, 172 services)
...
src/                   React frontend (100% .tsx — 116 components, 0 .jsx remaining)
  ...
  test/                253 test files, 3,516 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 3,516 tests (253 files; verified 2026-07-24)
