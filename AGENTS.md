...
- **Version**: 2.7.1 (security hardened, 290 test files, 4,199 tests, 191 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                290 test files, 4,199 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 4,199 tests (290 files; verified 2026-08-22)
