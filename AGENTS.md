...
- **Version**: 2.7.1 (security hardened, 293 test files, 4,199 tests, 191 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                293 test files, 4,199 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 4,199 tests (293 files)
