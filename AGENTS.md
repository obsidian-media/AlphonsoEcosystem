...
- **Version**: 2.6.1 (security hardened, 256 test files, 3,758 tests, 172 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                256 test files, 3,758 tests (Vitest; see ground truth for current verification status)
ios/                   iOS companion app (SwiftUI)
  ...
  src/lib.rs           ~2,061 lines, 108 Tauri commands (across 26 modules)
...
npm run test             # 3,758 tests (256 files; verified 2026-07-25)
...
## Do Not Duplicate
Before writing any new service, component, or feature, check `CLAUDE.md` "Do Not Duplicate" table at project root. 172 services already exist.
