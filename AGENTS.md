...
- **Version**: 2.7.1 (security hardened, 388 test files, 5,239 tests, 199 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  services/            199 services (policy-gated, not stubs; 185/185 audited line-by-line 2026-07-28)
  ...
  test/                388 test files, 5,239 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 5,239 tests (388 files)
