...
- **Version**: 2.7.1 (security hardened, 307 test files, 4,777 tests, 191 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                307 test files, 4,777 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 4,777 tests (307 files)
