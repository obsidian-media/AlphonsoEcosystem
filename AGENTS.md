...
- **Version**: 2.7.1 (security hardened, 397 test files, 5,239 tests, 200 services)
...
src/                   React frontend (132 .tsx, 39 .jsx — .jsx being migrated)
  ...
  test/                397 test files, 5,239 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 5,239 tests (397 files)
