...
- **Version**: 2.6.1 (security hardened, 255 test files, 3,753 tests, 172 services)
...
src/                   React frontend (100% .tsx — 116 components, 0 .jsx remaining)
  ...
  test/                255 test files, 3,753 tests (Vitest; see ground truth for current verification status)
...
npm run test             # 3,753 tests (255 files; verified 2026-07-25)
