...
- `src-tauri/src/lib.rs` is ~1,584 lines (18 modules in src/: `audit_log.rs`, `connector_commands.rs`, `kv_store.rs`, `main.rs`, `memory_store.rs`, `meta_publish.rs`, `native_proof.rs`, `ollama.rs`, `plugin_runtime.rs`, `policy_gate.rs`, `runway.rs`, `search.rs`, `telegram.rs`, `utils.rs`, `whatsapp_webhook.rs`, `workspace.rs`, `youtube.rs`, and `lib.rs` itself)
