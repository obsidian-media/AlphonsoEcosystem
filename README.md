...
- **117 Rust unit tests across 29 modules** — 110 Tauri commands across the modularised `src-tauri/src/` (up from 18 modules / 82 commands).
...
│                             ▼                                     │
│  ┌──────────────────────────────────────────────────────────┐    │
│  │  lib.rs ~2,043 lines · 110 Tauri commands · 29 modules   │    │
...
cargo test                     # 112 static Rust unit tests across 29 modules
