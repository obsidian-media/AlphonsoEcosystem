...
npm run test           # 5,239 tests across 364 files
...
Before writing any new service, component, or feature, check `CLAUDE.md` for the "Do Not Duplicate" table — 197 services already exist.
