...
- **121 Rust unit tests across 38 modules** — 113 Tauri commands across the modularised `src-tauri/src/` (up from 18 modules / 82 commands).
...
│                             ▼                                     │
│  ┌──────────────────────────────────────────────────────────┐    │
│  │  lib.rs ~801 lines · 113 Tauri commands · 38 modules   │    │
...
npm run test           # 4,199 tests across 287 files
