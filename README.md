...
<img src="https://raw.githubusercontent.com/obsidian-media/AlphonsoEcosystem/main/ALPHONSO_THUMBNAIL.webp" alt="Alphonso" width="180"/>

# Alphonso

> **v2.6.5** — Local-first AI desktop companion with 9 agents, 25 connectors, iOS companion app, Agent OS module system, Boardroom multi-agent sessions, and daily scheduler presets — powered by Ollama

[![Version](https://img.shields.io/badge/version-2.6.5-blue)](https://github.com/obsidian-media/AlphonsoEcosystem/releases)
...
- **117 Rust unit tests across 35 modules** — 110 Tauri commands across the modularised `src-tauri/src/` (up from 18 modules / 82 commands).
...
- **24 Connectors** — Ollama, Telegram, WhatsApp Cloud, YouTube, Mobile Bridge, ChatGPT, Claude API, Qwen, Notion, ClickUp, Stable Diffusion WebUI, ComfyUI Video, Runway, GitHub, Slack, Discord, Generic Webhook, Brave Search, Perplexity, Tavily, DeepSeek, NVIDIA NIM, Gemini, n8n
...
1. Go to [Releases](https://github.com/obsidian-media/AlphonsoEcosystem/releases)
...
│                             ▼                                     │
│  ┌──────────────────────────────────────────────────────────┐    │
│  │  lib.rs ~1,132 lines · 110 Tauri commands · 35 modules   │    │
...
npm run test           # 4,199 tests across 286 files
...
cargo test                     # 112 static Rust unit tests across 35 modules
...
Before writing any new service, component, or feature, check `CLAUDE.md` for the "Do Not Duplicate" table — 188 services already exist.
