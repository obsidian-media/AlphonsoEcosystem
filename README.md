...
npm run test           # 5,239 tests across 388 files
...
Before writing any new service, component, or feature, check `CLAUDE.md` for the "Do Not Duplicate" table — 199 services already exist.
