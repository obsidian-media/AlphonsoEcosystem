...
> **v2.6.3** — Local-first AI desktop companion with 9 agents, 25 connectors, iOS companion app, Agent OS module system, Boardroom multi-agent sessions, and daily scheduler presets — powered by Ollama

[![Version](https://img.shields.io/badge/version-2.6.3-blue)](https://github.com/obsidian-media/AlphonsoEcosystem/releases)
