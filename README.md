...
- **3,516 tests across 251 test files** — verified 2026-07-22; see the ground truth for current verification status.
...
npm run test           # 3,516 tests across 251 files
...
Before writing any new service, component, or feature, check `CLAUDE.md` for the "Do Not Duplicate" table — 170 services already exist.
