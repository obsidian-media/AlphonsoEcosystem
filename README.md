...
- **150 Rust unit tests across 38 modules** — 118 Tauri commands across the modularised `src-tauri/src/` (up from 18 modules / 82 commands).
...
│                             ▼                                     │
│  ┌──────────────────────────────────────────────────────────┐    │
│  │  lib.rs ~807 lines · 118 Tauri commands · 38 modules   │    │
