...
npm run test           # 5,182 tests across 356 files
...
Before writing any new service, component, or feature, check `CLAUDE.md` for the "Do Not Duplicate" table — 193 services already exist.
