...
const DEFAULT_WORKFLOW_OPERATIONS: WorkflowOperation[] = [
  {
    ...
    agentSequence: ['hector', 'miya', 'alphonso', 'maria', 'user_approval', 'marcus', 'jose'],
  ...
  },
  {
    ...
    agentSequence: ['hector', 'nova', 'miya', 'maria', 'jose', 'user_approval'],
  ...
  },
  {
    ...
    agentSequence: ['maria', 'sentinel', 'jose', 'user_approval', 'alphonso'],
