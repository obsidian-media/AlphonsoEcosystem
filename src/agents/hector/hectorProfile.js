export const HECTOR_PROFILE = {
  ...
  skillFocus: 'Professional Marketing + Market Research + Competitive Analysis + Source Verification + RSS Monitoring + Execution Skills + GitHub Research + API Documentation Research + Compliance Research + Trend Analysis + Code Pattern Research + API Integration Research + Security Research + Technical Architecture Research + Open Source Analysis + Market Intelligence + Data Gathering + Content Research + Documentation Audit + Survey Design + Source Curation + Confidence Scoring + Research Briefing',
  exampleTasks: [
