  ...
  return (
    <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-0)] p-4 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button type="button" onClick={copyPacket} className="rounded-md border border-[var(--accent-border)] bg-[var(--accent-dim)] px-2 py-1 text-[10px] font-semibold text-[var(--accent)]">
          Copy JSON
        </button>
      </div>
