...
function useOllamaStatus(): boolean | null {
...
export function AgentDock({ companions, embedded = false }: AgentDockProps) {
  ...
  const [position, setPosition] = useState<Position>(() => clampPosition(readStoredPosition()));
  const dragRef = useRef<{ startX: number; startY: number; originX: number; originY: number } | null>(null);
  const registryAgents: AgentProfile[] = listAgentProfiles();
