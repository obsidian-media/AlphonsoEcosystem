        ...
        {activeTab === 'live' && (
          <div className="space-y-4">
            {!r ? (
              ...
              <>
                <div className="rounded-2xl border border-white/[0.07] bg-[var(--surface-1)] p-4">
                ...
                <div className="rounded-2xl border border-white/[0.07] bg-[var(--surface-1)] p-4">
                  ...
                  <div className="space-y-1.5 max-h-64 overflow-y-auto pr-1">
                    {!r.runLog?.length ? (
                      ...
                      <div key={`${entry.timestampMs ?? 'n'}-${i}`} className="rounded-lg border border-white/[0.06] bg-[var(--surface-1)] px-3 py-2 text-[11px]">
