...
| Audit receipts | `GET /api/v1/workspaces/workspace-northstar/audit-receipts` | Read-only user/workspace-scoped accountability records, newest first. Every receipt has `execution_status: not_executed`. |
